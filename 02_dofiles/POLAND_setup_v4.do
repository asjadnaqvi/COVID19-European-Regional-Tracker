...
replace cases = 1498 if nuts2_id=="PL21" & date==22079

replace cases = 2364 if nuts2_id=="PL41" & date==22079
replace cases =  577 if nuts2_id=="PL42" & date==22079
replace cases =  131 if nuts2_id=="PL43" & date==22079
replace cases = 2757 if nuts2_id=="PL51" & date==22079
replace cases =  788 if nuts2_id=="PL52" & date==22079
replace cases =  586 if nuts2_id=="PL63" & date==22079
replace cases = 2337 if nuts2_id=="PL71" & date==22079
replace cases =  600 if nuts2_id=="PL72" & date==22079
replace cases =  536 if nuts2_id=="PL81" & date==22079
replace cases =  579 if nuts2_id=="PL84" & date==22079
replace cases = 4266 if nuts2_id=="PL91" & date==22079
replace cases = 5286 if nuts2_id=="PL92" & date==22079

replace cases = 10509 if nuts2_id=="PL22" & date==22079
replace cases =   614 if nuts2_id=="PL61" & date==22079
