...
copy "https://www.opendata.nhs.scot/dataset/b318bddf-a4dc-4262-971f-0ba329e09b87/resource/427f9a25-db22-4014-a3bc-893b68243055/download/trend_ca_20201113.csv" ///
	"scotland_raw.csv", replace
...
ren ca lad_id
keep lad_id date caname cases_daily cases
...
compress
save "$coviddir/04 master/scotland_data.dta", replace
export delimited using "$coviddir/04 master/csv/scotland_data.csv", replace delim(;)
