...
import delim using "https://raw.githubusercontent.com/radoondas/covid-19-slovakia/master/data/covid-19-slovensko-2020.csv", clear
replace v5 = "" if v5 != ""
replace v6 = "" if v6 != ""
destring _all, replace
save "$coviddir/04_master/slovakrep_data_original1.dta", replace

import delim using "https://raw.githubusercontent.com/radoondas/covid-19-slovakia/master/data/covid-19-slovensko-2021.csv", clear
destring _all, replace
save "$coviddir/04_master/slovakrep_data_original2.dta", replace

import delim using "https://raw.githubusercontent.com/radoondas/covid-19-slovakia/master/data/covid-19-slovensko-2022.csv", clear
destring _all, replace
save "$coviddir/04_master/slovakrep_data_original3.dta", replace


use 		 "$coviddir/04_master/slovakrep_data_original3.dta", clear
append using "$coviddir/04_master/slovakrep_data_original2.dta"
append using "$coviddir/04_master/slovakrep_data_original1.dta"
